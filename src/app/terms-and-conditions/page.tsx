    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-green-50 py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold text-green-800 mb-8 text-center">Terms &amp; Conditions</h1>
          ...
          <div className="prose-lg max-w-none">
            <div className="text-gray-700 space-y-6 mb-12 max-w-3xl mx-auto">
              <ol className="list-decimal pl-6 space-y-6 text-justify">
                ...
                <li className="leading-relaxed">
                  This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://play.google.com/store/apps/details?id=com.farmicon.fpo  websites https://play.google.com/store/apps/details?id=com.farmicon.fpo , https://play.google.com/store/apps/details?id=com.farmicon.application, https://play.google.com/store/apps/details?id=com.farmicon.business, https://farmicon.in (&apos;Websites&apos;), including the related mobile site and mobile application (hereinafter referred to as &apos;Platform&apos;).
                </li>
                <li className="leading-relaxed">
                  The Platform is owned by Farmicon India Private Limited, a company incorporated under the Companies Act, 1956 with its registered office at I-3, TIDES Business Incubator, IIT Roorkee , Roorkee ,India (hereinafter referred to as &apos;Platform Owner&apos;, &apos;we&apos;, &apos;us&apos;, &apos;our&apos;)..
                </li>
                <li className="leading-relaxed">
                ...
                <li className="leading-relaxed">
                  ...
                  <ol className="list-decimal pl-6 space-y-4 mt-4">
                    ...
                    <li className="leading-relaxed">
                      All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Roorkee and Uttarakhand.
                    </li>
                    <li className="leading-relaxed">
