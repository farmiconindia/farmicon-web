...
const HowItWorksSection = () => {
  ...
  const steps = [
    { 
      title: t('howItWorks.steps.downloadApp.title'),
      desc: t('howItWorks.steps.downloadApp.desc'),
      icon: (
    ...
    },
    {
      ...
      desc: t('howItWorks.steps.signUp.desc'),
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: t('howItWorks.steps.growAndProfit.title'),
      desc: t('howItWorks.steps.growAndProfit.desc'),
      icon: (
        <svg viewBox="0 0 24 24" className="w-8 h-8" fill="none" xmlns="http://www.w3.org/2000/svg">
